...
Sam and I refer to the [current Rotoforge setup](https://github.com/Sindry-Manufacturing/rotoforge) as "The Wheel", or alternatively, "The Screaming Wheel of Death". 
While it has many names, it is in short, a wheel that does a perpetual [burnout](https://en.wikipedia.org/wiki/Burnout_(vehicle)) on a surface to stir materials together. 
Seen another way, it is a saw blade or horizontal milling machine working in reverse. 
Seen another way, it is a rolling mill that uses friction to reduce contact forces. 
Seen another way  it is a surface grinder using galling to deposit rather than remove material. 
...
[Friction Rolling Additive Manufacturing (FRAM)](https://www.sciencedirect.com/science/article/abs/pii/S1526612525011089) is the most recent inspiration.  A process that is under study by a team at the beijing university of technology. Pingping Chen , Haibin Liu , Hezheng Liu , Yiyang Liu , Yangyang Xu , Ruishan Xie , Ying Chen , Shujun Chen. All your thorough and well written work formally characterizing this process and getting it into the literature is of great value.

[Solid State Extrusion and Roll Bonding (ERB-AM)](https://www.sciencedirect.com/science/article/abs/pii/S2214860423004943) more distant, stationary by design, but similar in concept, this technique elucidated most recently by a team at imperial college london, Yaping Wang , Zinong Tan , Wei Wang, Junquan Yu, Jing-Hua Zheng, Jian-Guo Lin, Jun Jiang is an inspiration for small scale high efficiency processing of strip, wire, sheet and foil via solid state lateral friction stir processing. Definitely deserves an acknowledgement. 

[Accumulative Roll Bonding (ARB)](https://advanced.onlinelibrary.wiley.com/doi/10.1002/adem.200310077) by a team at Osaka University, N. Tsuji, Y. Saito, S.-H. Lee, Y. Minamino. Their attention to detail in the process and metallurgical affinity has been an inspiration. 

[Lateral Rolling Additive Manufacturing (LRAM)](https://www.sciencedirect.com/science/article/pii/S1044580325009076) the team from various institutions in china, Hai Liu , Tongsheng Deng, Ziye Yang , Zhi Liu , Yupeng Yuan , Wei Chen , Wenhao He,  did some great work lateral thinking on lateral thinking with fast spinning taps. 
